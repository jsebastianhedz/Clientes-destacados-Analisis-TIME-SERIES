...
tic
[~,sheet_name]=xlsfinfo('CTO34KVPRIMEREADBalanceSEPTIEMBRE.xlsx');
for k=1:numel(sheet_name)
  CGM{k}=xlsread('CTO34KVPRIMEREADBalanceSEPTIEMBRE.xlsx',sheet_name{k});
end
toc

%% 2. Se realiza la organización de los datos en una serie de tiempo según el día analizar del mes
Dia=24; % ingresar el día analizar
DiaExclucion=25; %ingresa el día que no quiere analizar mayor a la v. Dia
...
filename = '2022SEPBALANCECGMResultados34kV.xlsx';
...
xlabel('24 horas-mes septiembre 2022')
xticks([])
xticklabels({})
yticks([])
